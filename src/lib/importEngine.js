...
export const blankFormula = () => ({ name: '', subject: '', folder: '', subFolder: '', topic: '', subtopic: '', formula: '', description: '', remarks: '', figureUrl: '', difficulty: '', variableSymbol1: '', variableMeaning1: '', variableUnit1: '', variableSymbol2: '', variableMeaning2: '', variableUnit2: '', variableSymbol3: '', variableMeaning3: '', variableUnit3: '', variableSymbol4: '', variableMeaning4: '', variableUnit4: '', variableSymbol5: '', variableMeaning5: '', variableUnit5: '', variables: '', units: '', conditions: '', applications: '', exampleProblem: '', solution: '', finalAnswer: '', commonMistakes: '', relatedFormulas: '', references: '', tags: '', sourceType: 'manual', visibility: 'private' });
...
export function mapSpreadsheetRow(row, type) {
  ...
  if (type === 'formula') return normalizeItem({
    name: first(values, 'name', 'formulaname', 'title'), subject: first(values, 'subject'),
    folder: first(values, 'folder', 'topic', 'category'), subFolder: first(values, 'subfolder', 'subtopic'),
    formula: first(values, 'formula', 'equation'), description: first(values, 'description'), remarks: first(values, 'remarks'),
    figureUrl: first(values, 'figureurl', 'imageurl'), difficulty: first(values, 'difficulty'),
    variableSymbol1: first(values, 'variablesymbol1'), variableMeaning1: first(values, 'variablemeaning1'), variableUnit1: first(values, 'variableunit1'),
    variableSymbol2: first(values, 'variablesymbol2'), variableMeaning2: first(values, 'variablemeaning2'), variableUnit2: first(values, 'variableunit2'),
    variableSymbol3: first(values, 'variablesymbol3'), variableMeaning3: first(values, 'variablemeaning3'), variableUnit3: first(values, 'variableunit3'),
    variableSymbol4: first(values, 'variablesymbol4'), variableMeaning4: first(values, 'variablemeaning4'), variableUnit4: first(values, 'variableunit4'),
    variableSymbol5: first(values, 'variablesymbol5'), variableMeaning5: first(values, 'variablemeaning5'), variableUnit5: first(values, 'variableunit5'),
    variables: first(values, 'variables'), units: first(values, 'units'), references: first(values, 'reference', 'references'), tags: splitValues(first(values, 'tags'))
  }, type, 'spreadsheet');
