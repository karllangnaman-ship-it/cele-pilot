    ...
    return normalizeItem(
      {
        ...
        variableSymbol6: first(values, "variablesymbol6"),
        variableMeaning6: first(values, "variablemeaning6"),
        variableUnit6: first(values, "variableunit6"),
        variableSymbol7: first(values, "variablesymbol7"),
        variableMeaning7: first(values, "variablemeaning7"),
        variableUnit7: first(values, "variableunit7"),
        variableSymbol8: first(values, "variablesymbol8"),
        variableMeaning8: first(values, "variablemeaning8"),
        variableUnit8: first(values, "variableunit8"),
        variableSymbol9: first(values, "variablesymbol9"),
        variableMeaning9: first(values, "variablemeaning9"),
        variableUnit9: first(values, "variableunit9"),
        variableSymbol10: first(values, "variablesymbol10"),
        variableMeaning10: first(values, "variablemeaning10"),
        variableUnit10: first(values, "variableunit10"),
  ...
  return normalizeItem(
    {
      ...
      questionSource: first(values, "questionsource") || null,
    },
    type,
    "spreadsheet",
  );
